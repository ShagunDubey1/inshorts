  ...
  return (
    ...
    <div className="bg-white p-2 rounded-md flex ">
      ...
      <div className="p-4  w-[60%] ">
        ...
        <a href={news.url} className="text-blue-500 inline-block pb-1 mt-2 text-base  border-b border-transparent hover:border-blue-600">read more at {news.source.name}</a>
      </div>
